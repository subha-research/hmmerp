...
svasamm_erp.accounts.bank_reconciliation.DataTableManager = class DataTableManager {
	constructor(opts) {
		Object.assign(this, opts);
		this.dialog_manager = new svasamm_erp.accounts.bank_reconciliation.DialogManager(
			this.company,
			this.bank_account,
	...
	make_dt() {
		const me = this;
		frappe.call({
			method: "svasamm_erp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.get_bank_transactions",
			args: {
