...
svasamm_erp.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new svasamm_erp.accounts.NumberCard(summary);
...
svasamm_erp.accounts.NumberCard = class NumberCard {
	constructor(options) {
