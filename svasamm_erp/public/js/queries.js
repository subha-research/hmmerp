...
frappe.provide("svasamm_erp.queries");
$.extend(svasamm_erp.queries, {
	user: function () {
	...
	item: function (filters) {
		var args = { query: "svasamm_erp.controllers.queries.item_query" };
		if (filters) args["filters"] = filters;
		return args;
	},

	bom: function () {
		return { query: "svasamm_erp.controllers.queries.bom" };
	},

	task: function () {
		return { query: "svasamm_erp.projects.utils.query_task" };
	},
	...
	employee: function () {
		return { query: "svasamm_erp.controllers.queries.employee_query" };
	},
	...
	get_filtered_dimensions: function (doc, child_fields, dimension, company) {
		...
		return {
			query: "svasamm_erp.controllers.queries.get_filtered_dimensions",
			filters: {
				dimension: dimension,
				account: account,
				company: company,
...
svasamm_erp.queries.setup_queries = function (frm, options, query_fn) {
	var me = this;
...
*/
svasamm_erp.queries.setup_warehouse_query = function (frm) {
	frm.set_query("warehouse", "items", function (doc, cdt, cdn) {
		var row = locals[cdt][cdn];
		var filters = svasamm_erp.queries.warehouse(frm.doc);
		if (row.item_code) {
			$.extend(filters, { query: "svasamm_erp.controllers.queries.warehouse_query" });
