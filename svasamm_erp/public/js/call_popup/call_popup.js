			...
			fields: [
				...
				},
				{
					...
					click: () => {
						...
						frappe
							.xcall(
								"svasamm_erp.telephony.doctype.call_log.call_log.add_call_summary_and_call_type",
								{
