frappe.provide("svasamm_erp.timesheet");

svasamm_erp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	svasamm_erp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

svasamm_erp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
