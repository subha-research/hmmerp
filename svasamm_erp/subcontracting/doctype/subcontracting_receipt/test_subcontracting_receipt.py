...
class TestSubcontractingReceipt(IntegrationTestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from svasamm_erp.controllers.subcontracting_controller import (
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(svasamm_erp.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_quality_inspection_for_subcontracting_receipt(self):
		from svasamm_erp.stock.doctype.quality_inspection.test_quality_inspection import (
