...
from svasamm_erp.stock.get_item_details import get_default_cost_center, get_default_expense_account
from svasamm_erp.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from svasamm_erp.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
