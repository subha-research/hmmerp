...
svasamm_erp.landed_cost_taxes_and_charges.setup_triggers("Subcontracting Receipt");
	...
	refresh: (frm) => {
		...
		if (!frm.doc.is_return && frm.doc.docstatus === 1 && frm.doc.per_returned < 100) {
			frm.add_custom_button(
				...
				() => {
					frappe.model.open_mapped_doc({
						method: "svasamm_erp.subcontracting.doctype.subcontracting_receipt.subcontracting_receipt.make_subcontract_return",
						frm: frm,
					});
				},
				__("Create")
