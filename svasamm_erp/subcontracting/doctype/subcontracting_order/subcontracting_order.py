...
from svasamm_erp.controllers.subcontracting_controller import SubcontractingController
from svasamm_erp.stock.stock_balance import update_bin_qty
...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from svasamm_erp.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from svasamm_erp.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
