...
from svasamm_erp.accounts.party import get_party_account_currency, get_party_details
from svasamm_erp.buying.utils import validate_for_items
from svasamm_erp.controllers.buying_controller import BuyingController
from svasamm_erp.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from svasamm_erp.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
