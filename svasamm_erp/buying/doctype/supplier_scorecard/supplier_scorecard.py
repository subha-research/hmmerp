...
from svasamm_erp.buying.doctype.supplier_scorecard_period.supplier_scorecard_period import (
...
class SupplierScorecard(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.buying.doctype.supplier_scorecard_scoring_standing.supplier_scorecard_scoring_standing import (
