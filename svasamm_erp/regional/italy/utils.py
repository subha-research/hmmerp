...
from svasamm_erp.controllers.taxes_and_totals import ItemWiseTaxDetail, get_itemised_tax
from svasamm_erp.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"svasamm_erp/regional/italy/e-invoice.xml",
