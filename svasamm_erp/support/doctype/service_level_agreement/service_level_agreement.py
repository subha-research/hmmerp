...
from svasamm_erp.support.doctype.issue.issue import get_holidays
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from svasamm_erp.support.doctype.service_day.service_day import ServiceDay
		from svasamm_erp.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from svasamm_erp.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
