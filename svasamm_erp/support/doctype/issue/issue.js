			...
			frm.add_custom_button(
				...
				function () {
					frappe.model.open_mapped_doc({
						method: "svasamm_erp.support.doctype.issue.issue.make_task",
						frm: frm,
					});
				},
				__("Create")
	...
	reset_service_level_agreement: function (frm) {
		let reset_sla = new frappe.ui.Dialog({
			...
			primary_action: (values) => {
				...
				frappe.call(
					"svasamm_erp.support.doctype.service_level_agreement.service_level_agreement.reset_service_level_agreement",
					{
