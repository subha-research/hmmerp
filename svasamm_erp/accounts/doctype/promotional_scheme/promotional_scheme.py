...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.campaign_item.campaign_item import CampaignItem
		from svasamm_erp.accounts.doctype.customer_group_item.customer_group_item import CustomerGroupItem
		from svasamm_erp.accounts.doctype.customer_item.customer_item import CustomerItem
		from svasamm_erp.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from svasamm_erp.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from svasamm_erp.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from svasamm_erp.accounts.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from svasamm_erp.accounts.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from svasamm_erp.accounts.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from svasamm_erp.accounts.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from svasamm_erp.accounts.doctype.supplier_item.supplier_item import SupplierItem
		from svasamm_erp.accounts.doctype.territory_item.territory_item import TerritoryItem
