...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from svasamm_erp.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
