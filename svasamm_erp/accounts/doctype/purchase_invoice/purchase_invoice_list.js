	...
	onload: function (listview) {
		if (frappe.model.can_create("Purchase Receipt")) {
			listview.page.add_action_item(__("Purchase Receipt"), () => {
				svasamm_erp.bulk_transaction_processing.create(listview, "Purchase Invoice", "Purchase Receipt");
			});
		}

		if (frappe.model.can_create("Payment Entry")) {
			listview.page.add_action_item(__("Payment"), () => {
				svasamm_erp.bulk_transaction_processing.create(listview, "Purchase Invoice", "Payment Entry");
			});
		}
	},
};
