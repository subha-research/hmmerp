...
class CurrencyExchangeSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.currency_exchange_settings_details.currency_exchange_settings_details import (
			CurrencyExchangeSettingsDetails,
		)
		from svasamm_erp.accounts.doctype.currency_exchange_settings_result.currency_exchange_settings_result import (
