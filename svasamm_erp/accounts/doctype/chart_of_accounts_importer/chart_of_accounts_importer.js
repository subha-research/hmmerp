frappe.ui.form.on("Chart of Accounts Importer", {
	...
	download_template: function (frm) {
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				open_url_post(
					"/api/method/svasamm_erp.accounts.doctype.chart_of_accounts_importer.chart_of_accounts_importer.download_template",
					{
	...
	company: function (frm) {
		if (frm.doc.company) {
			...
			frappe.call({
				method: "svasamm_erp.accounts.doctype.chart_of_accounts_importer.chart_of_accounts_importer.validate_company",
				args: {
...
var create_import_button = function (frm) {
	frm.page
		.set_primary_action(__("Import"), function () {
			return frappe.call({
				method: "svasamm_erp.accounts.doctype.chart_of_accounts_importer.chart_of_accounts_importer.import_coa",
				args: {
...
var validate_coa = function (frm) {
	if (frm.doc.import_file) {
		...
		return frappe.call({
			method: "svasamm_erp.accounts.doctype.chart_of_accounts_importer.chart_of_accounts_importer.get_coa",
			args: {
				file_name: frm.doc.import_file,
				parent: parent,
