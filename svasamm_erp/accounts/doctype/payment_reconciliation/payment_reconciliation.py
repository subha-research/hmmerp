...
from svasamm_erp.accounts.doctype.process_payment_reconciliation.process_payment_reconciliation import (
	is_any_doc_running,
)
...
from svasamm_erp.controllers.accounts_controller import get_advance_payment_entries_for_regional
...
class PaymentReconciliation(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.payment_reconciliation_allocation.payment_reconciliation_allocation import (
			PaymentReconciliationAllocation,
		)
		from svasamm_erp.accounts.doctype.payment_reconciliation_invoice.payment_reconciliation_invoice import (
			PaymentReconciliationInvoice,
		)
		from svasamm_erp.accounts.doctype.payment_reconciliation_payment.payment_reconciliation_payment import (
	...
	def get_jv_entries(self):
		...
		account_type = svasamm_erp.get_party_account_type(self.party_type)
	...
	def get_dr_or_cr_notes(self):
		...
		if svasamm_erp.get_party_account_type(self.party_type) == "Receivable":
				...
				"accounts": [
					{
						...
						"cost_center": inv.cost_center or svasamm_erp.get_default_cost_center(company),
