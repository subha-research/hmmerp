...
frappe.provide("svasamm_erp.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					svasamm_erp.cheque_print.view_cheque_print(frm);
				}
...
svasamm_erp.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "svasamm_erp.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
