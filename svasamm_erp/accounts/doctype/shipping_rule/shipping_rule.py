...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from svasamm_erp.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
