...
import svasamm_erp
from svasamm_erp.accounts.doctype.journal_entry.journal_entry import get_balance_on
from svasamm_erp.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	svasamm_erp.get_company_currency(company)
