...
from svasamm_erp.accounts.report.financial_statements import get_period_list
from svasamm_erp.accounts.report.profit_and_loss_statement.profit_and_loss_statement import execute
