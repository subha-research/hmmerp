...
import svasamm_erp
from svasamm_erp.accounts.report.balance_sheet.balance_sheet import (
	get_chart_data,
...
from svasamm_erp.accounts.report.cash_flow.cash_flow import (
	add_total_row_account,
	get_account_type_based_gl_data,
	get_cash_flow_accounts,
)
from svasamm_erp.accounts.report.cash_flow.cash_flow import get_report_summary as get_cash_flow_summary
...
from svasamm_erp.accounts.report.utils import convert, convert_to_presentation_currency
			...
			if d:
				...
				for company in companies:
					...
					if (
						...
						parent_company_currency = svasamm_erp.get_company_currency(d.company)
						child_company_currency = svasamm_erp.get_company_currency(entry.company)
