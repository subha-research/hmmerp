...
import svasamm_erp
from svasamm_erp.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
...
from svasamm_erp.accounts.report.utils import get_query_columns, get_values_for_columns
...
def _execute(filters=None, additional_table_columns=None):
	...
	company_currency = svasamm_erp.get_company_currency(filters.company)
