...
from svasamm_erp import get_company_currency, get_default_company
from svasamm_erp.accounts.doctype.accounting_dimension.accounting_dimension import (
	get_accounting_dimensions,
	get_dimension_with_children,
)
from svasamm_erp.accounts.doctype.fiscal_year.fiscal_year import get_from_and_to_date
...
def get_invoiced_item_gross_margin(sales_invoice=None, item_code=None, company=None, with_item_data=False):
	from svasamm_erp.accounts.report.gross_profit.gross_profit import GrossProfitGenerator
