...
from svasamm_erp.stock.doctype.quality_inspection_template.quality_inspection_template import (
...
class QualityInspection(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.stock.doctype.quality_inspection_reading.quality_inspection_reading import (
