...
class Shipment(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.stock.doctype.shipment_delivery_note.shipment_delivery_note import (
			ShipmentDeliveryNote,
		)
		from svasamm_erp.stock.doctype.shipment_parcel.shipment_parcel import ShipmentParcel
