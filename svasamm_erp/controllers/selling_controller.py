...
from svasamm_erp.accounts.party import render_address
from svasamm_erp.controllers.accounts_controller import get_taxes_and_charges
from svasamm_erp.controllers.sales_and_purchase_return import get_rate_for_return
from svasamm_erp.controllers.stock_controller import StockController
from svasamm_erp.stock.doctype.item.item import set_item_default
from svasamm_erp.stock.get_item_details import get_bin_details, get_conversion_factor
from svasamm_erp.stock.utils import get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from svasamm_erp.accounts.party import _get_party_details
			...
			from svasamm_erp.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from svasamm_erp.controllers.buying_controller import validate_item_type
