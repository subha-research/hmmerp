...
import svasamm_erp
from svasamm_erp.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from svasamm_erp.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
...
from svasamm_erp.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template, get_item_tax_map
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = svasamm_erp.get_company_currency(self.doc.company)
...
from svasamm_erp.deprecation_dumpster import (
