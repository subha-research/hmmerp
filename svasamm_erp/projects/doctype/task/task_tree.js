...
frappe.treeview_settings["Task"] = {
	get_tree_nodes: "svasamm_erp.projects.doctype.task.task.get_children",
	add_tree_node: "svasamm_erp.projects.doctype.task.task.add_node",
	filters: [
		{
			fieldname: "project",
			fieldtype: "Link",
			...
			click: function (node) {
				...
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: function () {
						dialog.hide();
						return frappe.call({
							method: "svasamm_erp.projects.doctype.task.task.add_multiple_tasks",
							args: {
