...
def task(doc_name, from_doctype, to_doctype):
	from svasamm_erp.accounts.doctype.payment_entry import payment_entry
	from svasamm_erp.accounts.doctype.purchase_invoice import purchase_invoice
	from svasamm_erp.accounts.doctype.sales_invoice import sales_invoice
	from svasamm_erp.buying.doctype.purchase_order import purchase_order
	from svasamm_erp.buying.doctype.supplier_quotation import supplier_quotation
	from svasamm_erp.selling.doctype.quotation import quotation
	from svasamm_erp.selling.doctype.sales_order import sales_order
	from svasamm_erp.stock.doctype.delivery_note import delivery_note
	from svasamm_erp.stock.doctype.purchase_receipt import purchase_receipt
