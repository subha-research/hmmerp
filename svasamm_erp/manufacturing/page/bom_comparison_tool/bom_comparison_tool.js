frappe.pages["bom-comparison-tool"].on_page_load = function (wrapper) {
	...
	new svasamm_erp.BOMComparisonTool(page);
};

svasamm_erp.BOMComparisonTool = class BOMComparisonTool {
	constructor(page) {
		this.page = page;
		this.make_form();
	}
	...
	fetch_and_render() {
		...
		frappe
			.call("svasamm_erp.manufacturing.doctype.bom.bom.get_bom_diff", {
				bom1: name1,
				bom2: name2,
			})
			.then((r) => {
