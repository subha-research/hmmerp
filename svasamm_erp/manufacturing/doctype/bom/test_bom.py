...
from svasamm_erp.manufacturing.doctype.bom.bom import BOMRecursionError, item_query, make_variant_bom
...
class TestBOM(IntegrationTestCase):
	...
	def test_get_items_list(self):
		from svasamm_erp.manufacturing.doctype.bom.bom import get_bom_items
	...
	def test_do_not_include_manufacturing_and_fixed_items(self):
		from svasamm_erp.manufacturing.doctype.bom.bom import item_query
