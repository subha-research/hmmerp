...
from svasamm_erp.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from svasamm_erp.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from svasamm_erp.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from svasamm_erp.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import JobCardScrapItem
		from svasamm_erp.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit=False):
		from svasamm_erp.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
