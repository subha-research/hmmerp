...
from svasamm_erp.crm.doctype.lead.lead import get_lead_with_phone_number
from svasamm_erp.crm.doctype.utils import get_scheduled_employees_for_popup, strip_number
