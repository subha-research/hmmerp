...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from svasamm_erp.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
