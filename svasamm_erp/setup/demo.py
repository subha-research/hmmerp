...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "svasamm_erp")
	try:
		...
		capture("demo_data_creation_failed", "svasamm_erp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "svasamm_erp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "svasamm_erp")
	try:
...
def make_transactions(company):
	...
	from svasamm_erp.accounts.utils import FiscalYearError
