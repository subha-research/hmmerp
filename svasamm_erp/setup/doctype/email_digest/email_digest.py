...
from svasamm_erp.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.setup.doctype.email_digest_recipient.email_digest_recipient import (
	...
	def get_msg_html(self):
		...
		from svasamm_erp.setup.doctype.email_digest.quotes import get_random_quote
		...
		return frappe.render_template(
			"svasamm_erp/setup/doctype/email_digest/templates/default.html", context, is_path=True
		)
