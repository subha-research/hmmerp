...
svasamm_erp.setup.EmployeeController = class EmployeeController extends frappe.ui.form.Controller {
	setup() {
...
frappe.ui.form.on("Employee", {
	...
	create_user: function (frm) {
		...
		frappe.call({
			method: "svasamm_erp.setup.doctype.employee.employee.create_user",
			args: {
...
cur_frm.cscript = new svasamm_erp.setup.EmployeeController({
	frm: cur_frm,
});
