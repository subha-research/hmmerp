...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from svasamm_erp.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
