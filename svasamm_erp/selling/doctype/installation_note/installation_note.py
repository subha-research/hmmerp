...
from svasamm_erp.stock.utils import get_valid_serial_nos
...
class InstallationNote(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from svasamm_erp.selling.doctype.installation_note_item.installation_note_item import (
	...
	def validate(self):
		...
		from svasamm_erp.controllers.selling_controller import set_default_income_account_for_item
