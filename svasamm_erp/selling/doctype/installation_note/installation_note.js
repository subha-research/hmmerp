...
svasamm_erp.selling.InstallationNote = class InstallationNote extends frappe.ui.form.Controller {
	refresh() {
		var me = this;
...
extend_cscript(cur_frm.cscript, new svasamm_erp.selling.InstallationNote({ frm: cur_frm }));
