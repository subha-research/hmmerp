...
from svasamm_erp.svasamm_integrations.doctype.plaid_settings.plaid_connector import PlaidConnector
...
def enqueue_synchronization():
	...
	for plaid_account in plaid_accounts:
		frappe.enqueue(
			"svasamm_erp.svasamm_erp_integrations.doctype.plaid_settings.plaid_settings.sync_transactions",
