...
from hmmerp.assets.doctype.asset.asset import get_asset_account
...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
			AssetRepairConsumedItem,
		)
		from hmmerp.assets.doctype.asset_repair_purchase_invoice.asset_repair_purchase_invoice import (
