...
frappe.ui.form.on("Asset Repair", {
	setup: function (frm) {
		...
		frm.set_query("purchase_invoice", "invoices", function () {
			return {
				query: "hmmerp.assets.doctype.asset_repair.asset_repair.get_purchase_invoice",
				filters: {
					company: frm.doc.company,
				},
			};
		...
		frm.set_query("expense_account", "invoices", function (doc, cdt, cdn) {
			...
			return {
				query: "hmmerp.assets.doctype.asset_repair.asset_repair.get_expense_accounts",
				filters: {
	...
	repair_status: (frm) => {
		if (frm.doc.completion_date && frm.doc.repair_status == "Completed") {
			frappe.call({
				method: "hmmerp.assets.doctype.asset_repair.asset_repair.get_downtime",
				args: {
