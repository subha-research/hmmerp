...
frappe.ui.form.on("Depreciation Schedule", {
	make_depreciation_entry: function (frm, cdt, cdn) {
		...
		if (!row.journal_entry) {
			frappe.call({
				method: "hmmerp.assets.doctype.asset.depreciation.make_depreciation_entry",
				args: {
	...
	depreciation_amount: function (frm, cdt, cdn) {
		hmmerp.asset.set_accumulated_depreciation(frm);
	},
});

hmmerp.asset.set_accumulated_depreciation = function (frm) {
