...
from hmmerp.accounts.general_ledger import make_reverse_gl_entries
...
class Asset(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.assets.doctype.asset_finance_book.asset_finance_book import AssetFinanceBook
	...
	def get_default_finance_book_idx(self):
		if not self.get("default_finance_book") and self.company:
			self.default_finance_book = hmmerp.get_default_finance_book(self.company)
