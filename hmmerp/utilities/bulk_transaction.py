...
def task(doc_name, from_doctype, to_doctype):
	from hmmerp.accounts.doctype.payment_entry import payment_entry
	from hmmerp.accounts.doctype.purchase_invoice import purchase_invoice
	from hmmerp.accounts.doctype.sales_invoice import sales_invoice
	from hmmerp.buying.doctype.purchase_order import purchase_order
	from hmmerp.buying.doctype.supplier_quotation import supplier_quotation
	from hmmerp.selling.doctype.quotation import quotation
	from hmmerp.selling.doctype.sales_order import sales_order
	from hmmerp.stock.doctype.delivery_note import delivery_note
	from hmmerp.stock.doctype.purchase_receipt import purchase_receipt
