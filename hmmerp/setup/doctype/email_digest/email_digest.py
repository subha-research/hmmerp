...
from hmmerp.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.setup.doctype.email_digest_recipient.email_digest_recipient import (
	...
	def get_msg_html(self):
		...
		from hmmerp.setup.doctype.email_digest.quotes import get_random_quote
		...
		return frappe.render_template(
			"hmmerp/setup/doctype/email_digest/templates/default.html", context, is_path=True
		)
