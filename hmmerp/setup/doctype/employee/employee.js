...
hmmerp.setup.EmployeeController = class EmployeeController extends frappe.ui.form.Controller {
	setup() {
...
frappe.ui.form.on("Employee", {
	...
	create_user: function (frm) {
		...
		frappe.call({
			method: "hmmerp.setup.doctype.employee.employee.create_user",
			args: {
...
cur_frm.cscript = new hmmerp.setup.EmployeeController({
	frm: cur_frm,
});
