...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from hmmerp.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
