...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "hmmerp")
	try:
		...
		capture("demo_data_creation_failed", "hmmerp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "hmmerp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "hmmerp")
	try:
...
def make_transactions(company):
	...
	from hmmerp.accounts.utils import FiscalYearError
