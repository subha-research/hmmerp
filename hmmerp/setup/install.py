...
from hmmerp.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/hmmerp">ERPNext</a></div>"""
...
def add_standard_navbar_items():
	...
	hmmerp_navbar_items = [
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/frappe/hmmerp/issues",
			"is_standard": 1,
		},
	]
	...
	for item in hmmerp_navbar_items:
