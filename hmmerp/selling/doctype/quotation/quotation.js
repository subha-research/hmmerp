...
hmmerp.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
hmmerp.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
hmmerp.pre_sales.set_as_lost("Quotation");
...
hmmerp.selling.QuotationController = class QuotationController extends hmmerp.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label() {
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = function () {
				return { query: "hmmerp.controllers.queries.lead_query" };
			};
	...
	get_lead_details() {
		...
		frappe.call({
			method: "hmmerp.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(hmmerp.selling.QuotationController);
