...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from hmmerp.selling.doctype.quotation_item.quotation_item import QuotationItem
		from hmmerp.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from hmmerp.crm.doctype.lead.lead import _make_customer
...
def create_customer_from_prospect(prospect_name, ignore_permissions=False):
	from hmmerp.crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
