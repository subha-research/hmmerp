...
from hmmerp.accounts.party import get_party_account
from hmmerp.controllers.selling_controller import SellingController
from hmmerp.manufacturing.doctype.blanket_order.blanket_order import (
...
from hmmerp.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from hmmerp.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from hmmerp.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from hmmerp.stock.doctype.packed_item.packed_item import is_product_bundle
