...
from hmmerp.accounts.test.accounts_mixin import AccountsTestMixin
from hmmerp.controllers.accounts_controller import InvalidQtyError, update_child_qty_rate
from hmmerp.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from hmmerp.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from hmmerp.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from hmmerp.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from hmmerp.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
	create_pick_list,
	make_delivery_note,
...
from hmmerp.stock.get_item_details import get_bin_details
...
class TestSalesOrder(AccountsTestMixin, IntegrationTestCase):
	...
	def test_drop_shipping(self):
		from hmmerp.buying.doctype.purchase_order.purchase_order import update_status
		from hmmerp.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from hmmerp.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from hmmerp.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from hmmerp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from hmmerp.controllers.item_variant import create_variant
		from hmmerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from hmmerp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from hmmerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from hmmerp.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from hmmerp.stock.doctype.material_request.material_request import raise_work_orders
	...
	@patch(
		...
		"hmmerp.accounts.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	def test_sales_order_advance_payment_status(self, mocked_get_payment_url):
		from hmmerp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from hmmerp.accounts.doctype.payment_request.payment_request import make_payment_request
	...
	def test_pick_list_for_batch(self):
		from hmmerp.stock.doctype.pick_list.pick_list import create_delivery_note
