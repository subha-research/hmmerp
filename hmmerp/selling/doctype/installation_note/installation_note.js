...
hmmerp.selling.InstallationNote = class InstallationNote extends frappe.ui.form.Controller {
	refresh() {
		var me = this;
...
extend_cscript(cur_frm.cscript, new hmmerp.selling.InstallationNote({ frm: cur_frm }));
