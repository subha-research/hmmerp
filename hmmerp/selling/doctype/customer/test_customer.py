...
from hmmerp.exceptions import PartyDisabled, PartyFrozen
from hmmerp.selling.doctype.customer.customer import (
	get_credit_limit,
...
class TestCustomer(IntegrationTestCase):
	...
	def test_customer_credit_limit_after_submit(self):
		from hmmerp.controllers.accounts_controller import update_child_qty_rate
		from hmmerp.selling.doctype.sales_order.test_sales_order import make_sales_order
