...
frappe.pages["sales-funnel"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel = new hmmerp.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
};

hmmerp.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "hmmerp.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_utm_source: "hmmerp.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_source",
			opp_by_utm_campaign: "hmmerp.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_campaign",
			opp_by_utm_medium: "hmmerp.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_medium",
			sales_pipeline: "hmmerp.selling.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({
