hmmerp.PointOfSale.ItemCart = class {
	...
	make_cart_numpad() {
		...
		this.number_pad = new hmmerp.PointOfSale.NumberPad({
			...
			return new Promise((resolve) => {
				frappe.db
					...
					.then(({ message }) => {
						...
						if (loyalty_program) {
							frappe.call({
								method: "hmmerp.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_program_details_with_points",
	...
	render_customer_fields() {
		...
		function handle_customer_field_change() {
			...
			if (this.value && current_value != this.value && this.df.fieldname != "loyalty_points") {
				frappe.call({
					method: "hmmerp.selling.page.point_of_sale.point_of_sale.set_customer_info",
					args: {
	...
	fetch_customer_transactions() {
		frappe
			.call({
				method: "hmmerp.selling.page.point_of_sale.point_of_sale.get_customer_recent_transactions",
