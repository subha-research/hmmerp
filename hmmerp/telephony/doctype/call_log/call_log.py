...
from hmmerp.crm.doctype.lead.lead import get_lead_with_phone_number
from hmmerp.crm.doctype.utils import get_scheduled_employees_for_popup, strip_number
