...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.subcontracting.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from hmmerp.subcontracting.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from hmmerp.subcontracting.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
