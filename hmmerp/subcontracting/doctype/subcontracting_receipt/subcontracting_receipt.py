...
from hmmerp.controllers.subcontracting_controller import SubcontractingController
...
from hmmerp.stock.get_item_details import get_default_cost_center, get_default_expense_account
from hmmerp.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from hmmerp.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, warehouse_account=None):
		...
		if not hmmerp.is_perpetual_inventory_enabled(self.company):
			return []
