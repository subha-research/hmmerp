...
frappe.provide("hmmerp.maintenance");
frappe.ui.form.on("Maintenance Visit", {
	...
	onload: function (frm) {
		...
		if (frm.doc.maintenance_type === "Scheduled") {
			...
			frappe
				.call({
					method: "hmmerp.maintenance.doctype.maintenance_schedule.maintenance_schedule.get_serial_nos_from_schedule",
					args: {
	...
	customer_address: function (frm) {
		hmmerp.utils.get_address_display(frm, "customer_address", "address_display");
	},
...
hmmerp.maintenance.MaintenanceVisit = class MaintenanceVisit extends frappe.ui.form.Controller {
	refresh() {
			...
			this.frm.add_custom_button(
				...
				function () {
					...
					hmmerp.utils.map_current_doc({
						method: "hmmerp.maintenance.doctype.maintenance_schedule.maintenance_schedule.make_maintenance_visit",
...
extend_cscript(cur_frm.cscript, new hmmerp.maintenance.MaintenanceVisit({ frm: cur_frm }));
