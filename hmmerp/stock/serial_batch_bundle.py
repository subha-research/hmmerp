...
from hmmerp.stock.deprecated_serial_batch import (
	DeprecatedBatchNoValuation,
	DeprecatedSerialNoValuation,
)
from hmmerp.stock.valuation import round_off_if_near_zero
...
class SerialBatchBundle:
	...
	def make_serial_batch_no_bundle_for_material_transfer(self):
		from hmmerp.controllers.stock_controller import make_bundle_for_material_transfer
	...
	def set_warehouse_and_status_in_serial_nos(self):
		from hmmerp.stock.doctype.serial_no.serial_no import get_serial_nos as get_parsed_serial_nos
