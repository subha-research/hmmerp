...
import hmmerp
from hmmerp.accounts.utils import get_currency_precision, get_stock_accounts
from hmmerp.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not hmmerp.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
