...
from hmmerp.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
from hmmerp.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from hmmerp.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from hmmerp.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = hmmerp.get_company_currency(self.filters.get("company"))
		else:
