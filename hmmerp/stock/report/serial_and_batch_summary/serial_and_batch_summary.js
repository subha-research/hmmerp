...
frappe.query_reports["Serial and Batch Summary"] = {
	filters: [
		...
		},
		{
			...
			get_query: function () {
				return {
					query: "hmmerp.stock.report.serial_and_batch_summary.serial_and_batch_summary.get_voucher_type",
				};
			},
		},
		{
		...
		},
		{
			...
			get_query: function () {
				return {
					query: "hmmerp.stock.report.serial_and_batch_summary.serial_and_batch_summary.get_serial_nos",
					filters: {
		...
		},
		{
			...
			get_query: function () {
				return {
					query: "hmmerp.stock.report.serial_and_batch_summary.serial_and_batch_summary.get_batch_nos",
					filters: {
						item_code: frappe.query_report.get_filter_value("item_code"),
						voucher_type: frappe.query_report.get_filter_value("voucher_type"),
						voucher_no: frappe.query_report.get_filter_value("voucher_no"),
