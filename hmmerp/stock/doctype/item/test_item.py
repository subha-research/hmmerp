...
class TestItem(IntegrationTestCase):
	...
	def test_check_stock_uom_with_bin_no_sle(self):
		from hmmerp.stock.stock_balance import update_bin_qty
	...
	def test_item_dashboard(self):
		from hmmerp.stock.dashboard.item_dashboard import get_data
	...
	def test_serach_fields_for_item(self):
		from hmmerp.controllers.queries import item_query
