...
from hmmerp.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from hmmerp.stock.get_item_details import ItemDetailsCtx, get_price_list_rate_for
...
class TestItemPrice(IntegrationTestCase):
	...
	def test_addition_of_new_fields(self):
		# Based on https://github.com/frappe/hmmerp/issues/8456
