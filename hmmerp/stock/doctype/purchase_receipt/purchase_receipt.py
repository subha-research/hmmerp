...
from hmmerp.controllers.accounts_controller import merge_taxes
from hmmerp.controllers.buying_controller import BuyingController
from hmmerp.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def make_item_gl_entries(self, gl_entries, warehouse_account=None):
		...
		for d in self.get("items"):
			...
			if (
				...
				if not (
					(hmmerp.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	from hmmerp.accounts.party import get_payment_terms_template
