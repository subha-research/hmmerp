...
import hmmerp
import hmmerp.controllers
import hmmerp.controllers.status_updater
from hmmerp.accounts.doctype.account.test_account import get_inventory_account
from hmmerp.buying.doctype.supplier.test_supplier import create_supplier
from hmmerp.controllers.accounts_controller import InvalidQtyError
from hmmerp.controllers.buying_controller import QtyMismatchError
from hmmerp.stock import get_warehouse_account_map
from hmmerp.stock.doctype.item.test_item import create_item, make_item
from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from hmmerp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
...
from hmmerp.stock.doctype.warehouse.test_warehouse import create_warehouse
...
class TestPurchaseReceipt(IntegrationTestCase):
	...
	def test_make_purchase_invoice(self):
		from hmmerp.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from hmmerp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(hmmerp.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from hmmerp.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from hmmerp.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from hmmerp.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from hmmerp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from hmmerp.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from hmmerp.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from hmmerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_stock_transfer_from_purchase_receipt_with_valuation(self):
		...
		from hmmerp.stock.get_item_details import get_valuation_rate
		from hmmerp.stock.utils import get_stock_balance
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from hmmerp.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from hmmerp.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from hmmerp.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from hmmerp.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from hmmerp.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from hmmerp.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from hmmerp.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from hmmerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from hmmerp.accounts.doctype.sales_invoice.sales_invoice import (
	...
	def test_disable_last_purchase_rate(self):
		from hmmerp.stock.get_item_details import ItemDetailsCtx, get_item_details
	...
	def test_purchase_receipt_with_backdated_landed_cost_voucher(self):
		from hmmerp.controllers.sales_and_purchase_return import make_return_doc
		from hmmerp.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_use_serial_batch_fields_for_serial_nos(self):
		from hmmerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from hmmerp.stock.doctype.serial_no.serial_no import get_serial_nos
		from hmmerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
			create_stock_reconciliation,
		)
	...
	def test_pr_billed_amount_against_return_entry(self):
		from hmmerp.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
		from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_valuation_taxes_lcv_repost_after_billing(self):
		...
		old_perpetual_inventory = hmmerp.is_perpetual_inventory_enabled("_Test Company")
	...
	def test_sles_with_same_posting_datetime_and_creation(self):
		from hmmerp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from hmmerp.stock.report.stock_balance.stock_balance import execute
	...
	def test_internal_pr_qty_change_only_single_batch(self):
		...
		self.assertRaises(hmmerp.controllers.status_updater.OverAllowanceError, pr.submit)
...
def prepare_data_for_internal_transfer():
	from hmmerp.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
