...
from hmmerp.accounts.party import get_due_date
from hmmerp.controllers.accounts_controller import get_taxes_and_charges, merge_taxes
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem
