...
frappe.ui.form.on("Material Request", {
	...
	update_status: function (frm, stop_status) {
		frappe.call({
			method: "hmmerp.stock.doctype.material_request.material_request.update_status",
		...
		frappe.prompt(
			{
				...
				get_query: () => {
					return {
						query: "hmmerp.stock.doctype.material_request.material_request.get_default_supplier_query",
	...
	make_request_for_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "hmmerp.stock.doctype.material_request.material_request.make_request_for_quotation",
			frm: frm,
			run_link_triggers: true,
		});
	},
	...
	make_supplier_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "hmmerp.stock.doctype.material_request.material_request.make_supplier_quotation",
			frm: frm,
		});
	},
	...
	make_in_transit_stock_entry(frm) {
		frappe.prompt(
			...
			(values) => {
				frappe.call({
					method: "hmmerp.stock.doctype.material_request.material_request.make_in_transit_stock_entry",
					args: {
	...
	create_pick_list: (frm) => {
		frappe.model.open_mapped_doc({
			method: "hmmerp.stock.doctype.material_request.material_request.create_pick_list",
			frm: frm,
		});
	},
	...
	raise_work_orders: function (frm) {
		frappe.call({
			method: "hmmerp.stock.doctype.material_request.material_request.raise_work_orders",
			args: {
...
hmmerp.buying.MaterialRequestController = class MaterialRequestController extends (
...
extend_cscript(cur_frm.cscript, new hmmerp.buying.MaterialRequestController({ frm: cur_frm }));
