...
from hmmerp.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
