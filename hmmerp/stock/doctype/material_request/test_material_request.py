...
from hmmerp.stock.doctype.material_request.material_request import (
...
class TestMaterialRequest(IntegrationTestCase):
	...
	def test_partial_make_stock_entry(self):
		from hmmerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from hmmerp.stock.reorder_item import get_email_list
