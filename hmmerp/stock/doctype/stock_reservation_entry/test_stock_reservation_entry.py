...
from hmmerp.selling.doctype.sales_order.sales_order import create_pick_list, make_delivery_note
...
from hmmerp.stock.doctype.stock_entry.stock_entry import StockEntry
...
class TestStockReservationEntry(IntegrationTestCase):
	...
	def test_stock_reservation_from_purchase_receipt(self) -> None:
		...
		from hmmerp.selling.doctype.sales_order.sales_order import make_material_request
