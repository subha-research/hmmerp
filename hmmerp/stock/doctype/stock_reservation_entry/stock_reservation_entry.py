...
from hmmerp.stock.utils import get_or_make_bin, get_stock_balance
...
class StockReservationEntry(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
	...
	def auto_reserve_serial_and_batch(self, based_on: str | None = None) -> None:
		...
		if (
			...
			from hmmerp.stock.serial_batch_bundle import get_serial_nos_batch
...
def create_stock_reservation_entries_for_so_items(
	...
	from hmmerp.selling.doctype.sales_order.sales_order import get_unreserved_qty
