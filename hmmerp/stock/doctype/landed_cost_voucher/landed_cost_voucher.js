...
hmmerp.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
hmmerp.stock.LandedCostVoucher = class LandedCostVoucher extends hmmerp.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(hmmerp.stock.LandedCostVoucher);
...
frappe.ui.form.on("Landed Cost Voucher", {
	...
	setup_queries(frm) {
		...
		frm.set_query("vendor_invoice", "vendor_invoices", (doc, cdt, cdn) => {
			return {
				query: "hmmerp.stock.doctype.landed_cost_voucher.landed_cost_voucher.get_vendor_invoices",
				filters: {
					company: doc.company,
				},
			};
