...
class LandedCostVoucher(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.landed_cost_item.landed_cost_item import LandedCostItem
		from hmmerp.stock.doctype.landed_cost_purchase_receipt.landed_cost_purchase_receipt import (
		...
		from hmmerp.stock.doctype.landed_cost_vendor_invoice.landed_cost_vendor_invoice import (
		...
		for pr in self.get("purchase_receipts"):
			if pr.receipt_document_type and pr.receipt_document:
				...
				for d in pr_items:
					...
					item.cost_center = d.cost_center or hmmerp.get_default_cost_center(self.company)
