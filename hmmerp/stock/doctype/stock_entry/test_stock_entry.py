...
from hmmerp.stock.doctype.item.test_item import (
	create_item,
	make_item,
	make_item_variant,
...
from hmmerp.stock.doctype.serial_no.serial_no import *
from hmmerp.stock.doctype.stock_entry.stock_entry import FinishedGoodError, make_stock_in_entry
from hmmerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
from hmmerp.stock.doctype.stock_ledger_entry.stock_ledger_entry import StockFreezeError
...
from hmmerp.stock.stock_ledger import NegativeStockError, get_previous_sle
...
class TestStockEntry(IntegrationTestCase):
	...
	def _test_auto_material_request(
		...
		from hmmerp.stock.reorder_item import reorder_item
	...
	def test_variant_work_order(self):
		...
		from hmmerp.manufacturing.doctype.work_order.work_order import make_stock_entry
	...
	def test_future_negative_sle_batch(self):
		from hmmerp.stock.doctype.batch.test_batch import TestBatch
	...
	def test_mapped_stock_entry(self):
		...
		from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import make_stock_entry
	...
	def test_reposting_for_depedent_warehouse(self):
		from hmmerp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_sl_entries
		from hmmerp.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_batch_expiry(self):
		from hmmerp.controllers.stock_controller import BatchExpiredError
		from hmmerp.stock.doctype.batch.test_batch import make_new_batch
...
def initialize_records_for_future_negative_sle_test(
	...
	from hmmerp.stock.doctype.batch.test_batch import TestBatch, make_new_batch
	from hmmerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
		create_stock_reconciliation,
	)
	from hmmerp.stock.doctype.warehouse.test_warehouse import create_warehouse
