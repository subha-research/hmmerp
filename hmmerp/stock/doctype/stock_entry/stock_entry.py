...
import hmmerp
from hmmerp.accounts.general_ledger import process_gl_map
from hmmerp.accounts.utils import get_account_currency
from hmmerp.buying.utils import check_on_hold_or_closed_status
from hmmerp.controllers.taxes_and_totals import init_landed_taxes_and_totals
from hmmerp.manufacturing.doctype.bom.bom import (
	add_additional_cost,
...
from hmmerp.setup.doctype.brand.brand import get_brand_defaults
from hmmerp.setup.doctype.item_group.item_group import get_item_group_defaults
from hmmerp.stock.doctype.batch.batch import get_batch_qty
from hmmerp.stock.doctype.item.item import get_item_defaults
from hmmerp.stock.doctype.serial_no.serial_no import get_serial_nos
from hmmerp.stock.doctype.stock_reconciliation.stock_reconciliation import (
...
from hmmerp.stock.serial_batch_bundle import (
	SerialBatchCreation,
	get_empty_batches_based_work_order,
	get_serial_or_batch_items,
)
from hmmerp.stock.stock_ledger import NegativeStockError, get_previous_sle, get_valuation_rate
from hmmerp.stock.utils import get_bin, get_incoming_rate
...
from hmmerp.controllers.stock_controller import StockController
...
class StockEntry(StockController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.landed_cost_taxes_and_charges.landed_cost_taxes_and_charges import (
			LandedCostTaxesandCharges,
		)
		from hmmerp.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from hmmerp.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def validate_difference_account(self):
		if not cint(hmmerp.is_perpetual_inventory_enabled(self.company)):
			return
	...
	def set_actual_qty(self):
		from hmmerp.stock.stock_ledger import is_negative_stock_allowed
		...
		for d in self.get("items"):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				...
				d.basic_rate = get_valuation_rate(
					...
					currency=hmmerp.get_company_currency(self.company),
					company=self.company,
	...
	def get_bom_raw_materials(self, qty):
		from hmmerp.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_subcontracting_order_status(self):
		if self.subcontracting_order and self.purpose in ["Send to Subcontractor", "Material Transfer"]:
			from hmmerp.subcontracting.doctype.subcontracting_order.subcontracting_order import (
	...
	def update_pick_list_status(self):
		from hmmerp.stock.doctype.pick_list.pick_list import update_pick_list_status
...
def move_sample_to_retention_warehouse(company, items):
	...
	from hmmerp.stock.serial_batch_bundle import SerialBatchCreation
...
def get_expired_batch_items():
	from hmmerp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_auto_batch_nos
...
def get_items_from_subcontract_order(source_name, target_doc=None):
	from hmmerp.controllers.subcontracting_controller import make_rm_stock_entry
