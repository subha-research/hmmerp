...
class Shipment(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.stock.doctype.shipment_delivery_note.shipment_delivery_note import (
			ShipmentDeliveryNote,
		)
		from hmmerp.stock.doctype.shipment_parcel.shipment_parcel import ShipmentParcel
