...
from hmmerp.controllers.item_variant import ItemTemplateCannotHaveStock
from hmmerp.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from hmmerp.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from hmmerp.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from hmmerp.stock.utils import is_group_warehouse
