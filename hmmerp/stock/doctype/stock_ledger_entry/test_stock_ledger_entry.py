...
from hmmerp.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from hmmerp.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(IntegrationTestCase, StockTestMixin):
	...
	def test_tie_breaking(self):
		from hmmerp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_entries
