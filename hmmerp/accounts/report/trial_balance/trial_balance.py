...
from hmmerp.accounts.report.utils import convert_to_presentation_currency, get_currency
...
def get_data(filters):
	...
	company_currency = filters.presentation_currency or hmmerp.get_company_currency(filters.company)
