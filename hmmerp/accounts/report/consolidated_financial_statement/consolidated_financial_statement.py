...
import hmmerp
from hmmerp.accounts.report.balance_sheet.balance_sheet import (
	get_chart_data,
...
from hmmerp.accounts.report.cash_flow.cash_flow import (
	add_total_row_account,
	get_account_type_based_gl_data,
	get_cash_flow_accounts,
)
from hmmerp.accounts.report.cash_flow.cash_flow import get_report_summary as get_cash_flow_summary
from hmmerp.accounts.report.financial_statements import (
	filter_out_zero_value_rows,
	get_fiscal_year_data,
	sort_accounts,
)
from hmmerp.accounts.report.profit_and_loss_statement.profit_and_loss_statement import (
...
from hmmerp.accounts.report.utils import convert, convert_to_presentation_currency
			...
			if d:
				...
				for company in companies:
					...
					if (
						...
						parent_company_currency = hmmerp.get_company_currency(d.company)
						child_company_currency = hmmerp.get_company_currency(entry.company)
