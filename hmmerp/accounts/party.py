...
from hmmerp.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def set_taxes(
	...
	from hmmerp.accounts.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
