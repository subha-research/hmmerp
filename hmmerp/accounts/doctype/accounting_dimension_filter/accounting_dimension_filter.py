...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from hmmerp.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)
