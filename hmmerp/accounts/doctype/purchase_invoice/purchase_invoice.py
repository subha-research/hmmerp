...
from hmmerp.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from hmmerp.accounts.party import get_due_date, get_party_account
from hmmerp.accounts.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
from hmmerp.assets.doctype.asset.asset import is_cwip_accounting_enabled
from hmmerp.assets.doctype.asset_category.asset_category import get_asset_category_account
from hmmerp.buying.utils import check_on_hold_or_closed_status
from hmmerp.controllers.accounts_controller import validate_account_head
from hmmerp.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.advance_tax.advance_tax import AdvanceTax
		...
		from hmmerp.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from hmmerp.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from hmmerp.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from hmmerp.accounts.doctype.tax_withheld_vouchers.tax_withheld_vouchers import TaxWithheldVouchers
		from hmmerp.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = hmmerp.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
