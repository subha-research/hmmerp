...
from hmmerp.buying.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
from hmmerp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice as make_pi_from_po
...
from hmmerp.controllers.accounts_controller import InvalidQtyError, get_payment_terms
from hmmerp.controllers.buying_controller import QtyMismatchError
from hmmerp.exceptions import InvalidCurrency
...
from hmmerp.stock.doctype.material_request.material_request import make_purchase_order
from hmmerp.stock.doctype.material_request.test_material_request import make_material_request
from hmmerp.stock.doctype.purchase_receipt.purchase_receipt import (
	make_purchase_invoice as create_purchase_invoice_from_receipt,
)
from hmmerp.stock.doctype.purchase_receipt.test_purchase_receipt import (
	get_taxes,
...
from hmmerp.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
from hmmerp.stock.tests.test_utils import StockTestMixin
...
class TestPurchaseInvoice(IntegrationTestCase, StockTestMixin):
	...
	def test_update_received_qty_in_material_request(self):
		from hmmerp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
	...
	def test_gl_entries_without_perpetual_inventory(self):
		...
		self.assertTrue(not cint(hmmerp.is_perpetual_inventory_enabled(pi.company)))
		pi.insert()
		pi.submit()
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(hmmerp.is_perpetual_inventory_enabled(pi.company)), 1)
	...
	def test_debit_note(self):
		from hmmerp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from hmmerp.accounts.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
	...
	def test_offsetting_entries_for_accounting_dimensions(self):
		...
		from hmmerp.accounts.report.trial_balance.test_trial_balance import (
	...
	def test_make_pr_and_pi_from_po(self):
		from hmmerp.assets.doctype.asset.test_asset import create_asset_category
