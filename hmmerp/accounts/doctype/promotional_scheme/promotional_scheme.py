...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.campaign_item.campaign_item import CampaignItem
		from hmmerp.accounts.doctype.customer_group_item.customer_group_item import CustomerGroupItem
		from hmmerp.accounts.doctype.customer_item.customer_item import CustomerItem
		from hmmerp.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from hmmerp.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from hmmerp.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from hmmerp.accounts.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from hmmerp.accounts.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from hmmerp.accounts.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from hmmerp.accounts.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from hmmerp.accounts.doctype.supplier_item.supplier_item import SupplierItem
		from hmmerp.accounts.doctype.territory_item.territory_item import TerritoryItem
