...
class POSOpeningEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pos_opening_entry_detail.pos_opening_entry_detail import (
	...
	def check_poe_is_cancellable(self):
		from hmmerp.accounts.doctype.pos_closing_entry.pos_closing_entry import get_invoices
