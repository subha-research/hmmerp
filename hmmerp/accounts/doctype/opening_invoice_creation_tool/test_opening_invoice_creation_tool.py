...
from hmmerp.accounts.doctype.opening_invoice_creation_tool.opening_invoice_creation_tool import (
...
class TestOpeningInvoiceCreationTool(IntegrationTestCase):
	...
	def test_opening_sales_invoice_creation_with_missing_debit_account(self):
		...
		error_log = frappe.db.exists(
			"Error Log",
			{"error": ["like", "%hmmerp.controllers.accounts_controller.AccountMissingError%"]},
		)
