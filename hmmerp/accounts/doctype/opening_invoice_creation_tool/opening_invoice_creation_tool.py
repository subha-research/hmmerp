...
from hmmerp.stock.utils import get_default_stock_uom
...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
		...
		invoice = frappe._dict(
			{
				...
				"update_stock": 0,  # important: https://github.com/frappe/hmmerp/pull/23559
