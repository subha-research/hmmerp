...
from hmmerp.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from hmmerp.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from hmmerp.accounts.doctype.pos_invoice_reference.pos_invoice_reference import POSInvoiceReference
		from hmmerp.accounts.doctype.sales_invoice_reference.sales_invoice_reference import (
