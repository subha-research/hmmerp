...
frappe.ui.form.on("POS Closing Entry", {
	onload: async function (frm) {
		...
		frm.set_query("user", function (doc) {
			return {
				query: "hmmerp.accounts.doctype.pos_closing_entry.pos_closing_entry.get_cashiers",
	...
	get_invoices(frm) {
		return frappe.call({
			method: "hmmerp.accounts.doctype.pos_closing_entry.pos_closing_entry.get_invoices",
			args: {
