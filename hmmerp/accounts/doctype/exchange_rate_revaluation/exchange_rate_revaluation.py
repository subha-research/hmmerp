...
import hmmerp
from hmmerp.accounts.doctype.journal_entry.journal_entry import get_balance_on
from hmmerp.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	hmmerp.get_company_currency(company)
