...
class BankTransaction(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.bank_transaction_payments.bank_transaction_payments import (
	...
	def auto_set_party(self):
		from hmmerp.accounts.doctype.bank_transaction.auto_match_party import AutoMatchParty
