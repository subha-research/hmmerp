...
frappe.ui.form.on("Bank Statement Import", {
	...
	show_import_status(frm) {
		...
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_statement_import.bank_statement_import.get_import_status",
			args: {
	...
	export_errored_rows(frm) {
		open_url_post(
			"/api/method/hmmerp.accounts.doctype.bank_statement_import.bank_statement_import.download_errored_template",
			{
	...
	export_import_log(frm) {
		open_url_post(
			"/api/method/hmmerp.accounts.doctype.bank_statement_import.bank_statement_import.download_import_log",
			{
				data_import_name: frm.doc.name,
			}
		);
	...
	render_import_log(frm) {
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_statement_import.bank_statement_import.get_import_logs",
			args: {
				docname: frm.doc.name,
			},
			callback: function (r) {
