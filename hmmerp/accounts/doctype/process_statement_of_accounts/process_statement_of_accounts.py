...
from hmmerp.accounts.party import get_party_account_currency
from hmmerp.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from hmmerp.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from hmmerp.accounts.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from hmmerp.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from hmmerp.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from hmmerp.accounts.doctype.psoa_project.psoa_project import PSOAProject
...
def get_html(doc, filters, entry, col, res, ageing):
	...
	template_path = "hmmerp/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts_accounts_receivable.html"
	if doc.report == "General Ledger":
		template_path = (
			"hmmerp/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts.html"
		)
