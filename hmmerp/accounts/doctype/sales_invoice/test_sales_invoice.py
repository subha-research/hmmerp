...
import hmmerp
from hmmerp.accounts.doctype.account.test_account import create_account, get_inventory_account
from hmmerp.accounts.doctype.mode_of_payment.test_mode_of_payment import (
	set_default_account_for_mode_of_payment,
)
from hmmerp.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from hmmerp.accounts.doctype.purchase_invoice.purchase_invoice import WarehouseMissingError
from hmmerp.accounts.doctype.purchase_invoice.test_purchase_invoice import (
	unlink_payment_on_cancel_of_invoice,
)
from hmmerp.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
from hmmerp.accounts.utils import PaymentEntryUnlinkError
from hmmerp.assets.doctype.asset.depreciation import post_depreciation_entries
from hmmerp.assets.doctype.asset.test_asset import create_asset, create_asset_data
from hmmerp.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
	get_depr_schedule,
)
from hmmerp.controllers.accounts_controller import InvalidQtyError, update_invoice_status
from hmmerp.controllers.taxes_and_totals import get_itemised_tax_breakup_data
from hmmerp.exceptions import InvalidAccountCurrency, InvalidCurrency
from hmmerp.selling.doctype.customer.test_customer import get_customer_dict
from hmmerp.stock.doctype.delivery_note.delivery_note import make_sales_invoice
from hmmerp.stock.doctype.item.test_item import create_item
from hmmerp.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt
from hmmerp.stock.doctype.serial_and_batch_bundle.test_serial_and_batch_bundle import (
	get_batch_from_bundle,
	get_serial_nos_from_bundle,
	make_serial_batch_bundle,
)
from hmmerp.stock.doctype.stock_entry.test_stock_entry import (
	get_qty_after_transaction,
	make_stock_entry,
)
from hmmerp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from hmmerp.stock.get_item_details import get_item_tax_map
from hmmerp.stock.utils import get_incoming_rate, get_stock_balance
from hmmerp.tests.utils import ERPNextTestSuite


class TestSalesInvoice(ERPNextTestSuite):
	def setUp(self):
		from hmmerp.stock.doctype.stock_ledger_entry.test_stock_ledger_entry import create_items
	...
	def test_invalid_rate_without_override(self):
		...
		from hmmerp.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_purchase_invoice
	...
	def test_outstanding_on_cost_center_allocation(self):
		# setup cost centers
		from hmmerp.accounts.doctype.cost_center.test_cost_center import create_cost_center
		from hmmerp.accounts.doctype.cost_center_allocation.test_cost_center_allocation import (
	...
	def test_pos_returns_with_repayment(self):
		from hmmerp.accounts.doctype.sales_invoice.sales_invoice import make_sales_return
	...
	def test_bin_details_of_packed_item(self):
		from hmmerp.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
	...
	def test_serialized(self):
		from hmmerp.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_serial_numbers_against_delivery_note(self):
		...
		"""
		from hmmerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from hmmerp.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
		...
		from hmmerp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_rounding_adjustment_3(self):
		from hmmerp.accounts.doctype.accounting_dimension.test_accounting_dimension import create_dimension
	...
	def test_sales_invoice_with_shipping_rule(self):
		from hmmerp.accounts.doctype.shipping_rule.test_shipping_rule import create_shipping_rule
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		old_perpetual_inventory = hmmerp.is_perpetual_inventory_enabled("_Test Company 1")
	...
	def test_additional_discount_for_sales_invoice_with_discount_accounting_enabled(self):
		from hmmerp.accounts.doctype.repost_accounting_ledger.test_repost_accounting_ledger import (
	...
	def test_sales_invoice_against_supplier(self):
		from hmmerp.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from hmmerp.accounts.doctype.party_link.party_link import create_party_link
		from hmmerp.buying.doctype.supplier.test_supplier import create_supplier
	...
	def test_gain_loss_with_advance_entry(self):
		from hmmerp.accounts.doctype.journal_entry.test_journal_entry import make_journal_entry
	...
	def test_batch_expiry_for_sales_invoice_return(self):
		from hmmerp.controllers.sales_and_purchase_return import make_return_doc
		from hmmerp.stock.doctype.item.test_item import make_item
	...
	def test_advance_entries_as_liability(self):
		from hmmerp.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
	...
	def test_loyalty_points_redemption_with_shopping_cart(self):
		from hmmerp.accounts.doctype.loyalty_program.test_loyalty_program import (
			create_records,
			create_sales_invoice_record,
		)
		from hmmerp.selling.doctype.sales_order.sales_order import make_sales_invoice
		from hmmerp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_taxes_merging_from_delivery_note(self):
		...
		map_docs(
			method="hmmerp.stock.doctype.delivery_note.delivery_note.make_sales_invoice",
	...
	def test_create_return_invoice_for_self_update(self):
		from hmmerp.accounts.doctype.payment_entry.payment_entry import get_payment_entry
		from hmmerp.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
		from hmmerp.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_prevents_fully_returned_invoice_with_zero_quantity(self):
		from hmmerp.controllers.sales_and_purchase_return import StockOverReturnError, make_return_doc
...
def create_internal_parties():
	from hmmerp.selling.doctype.customer.test_customer import create_internal_customer
