...
frappe.provide("hmmerp.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					hmmerp.cheque_print.view_cheque_print(frm);
				}
...
hmmerp.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "hmmerp.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
