...
class POSSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pos_field.pos_field import POSField
		from hmmerp.accounts.doctype.pos_search_fields.pos_search_fields import POSSearchFields
