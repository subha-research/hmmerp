...
from hmmerp.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from hmmerp.accounts.party import get_party_account, get_party_bank_account
from hmmerp.accounts.utils import get_account_currency, get_advance_payment_doctypes, get_currency_precision
from hmmerp.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
