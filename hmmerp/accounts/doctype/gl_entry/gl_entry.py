...
from hmmerp.accounts.utils import OUTSTANDING_DOCTYPES, get_account_currency, get_fiscal_year
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = hmmerp.get_company_currency(entries[0].company)
