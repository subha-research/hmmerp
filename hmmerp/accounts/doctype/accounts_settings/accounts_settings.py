...
from hmmerp.accounts.utils import sync_auto_reconcile_config
from hmmerp.stock.utils import check_pending_reposting
...
class AccountsSettings(Document):
	...
	def drop_ar_sql_procedures(self):
		from hmmerp.accounts.report.accounts_receivable.accounts_receivable import InitSQLProceduresForAR
