...
from hmmerp.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from hmmerp.exceptions import InvalidAccountCurrency
...
class TestJournalEntry(IntegrationTestCase):
	...
	def test_reverse_journal_entry(self):
		from hmmerp.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry
