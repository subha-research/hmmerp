...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from hmmerp.accounts.doctype.pos_item_group.pos_item_group import POSItemGroup
		from hmmerp.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from hmmerp.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser
