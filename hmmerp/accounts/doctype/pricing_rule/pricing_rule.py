...
class PricingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import PricingRuleItemCode
...
def apply_price_discount_rule(pricing_rule, item_details, args):
	...
	if pricing_rule.rate_or_discount == "Rate":
		...
		# TODO https://github.com/frappe/svasamm_rp/pull/23636 solve this in some other way.
