...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from hmmerp.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
