...
from hmmerp.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
...
from hmmerp.controllers.queries import item_query as _item_query
from hmmerp.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
