...
from hmmerp.accounts.doctype.pos_invoice.pos_invoice import make_sales_return
from hmmerp.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from hmmerp.accounts.doctype.sales_invoice.sales_invoice import PartialPaymentValidationError
...
class TestPOSInvoice(IntegrationTestCase):
	...
	def setUpClass(cls):
		...
		from hmmerp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
		from hmmerp.accounts.doctype.pos_opening_entry.test_pos_opening_entry import create_opening_entry
	...
	def test_loyalty_points(self):
		...
		from hmmerp.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_merging_into_sales_invoice_with_discount(self):
		from hmmerp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
	...
	def test_ignore_pricing_rule(self):
		from hmmerp.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from hmmerp.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
