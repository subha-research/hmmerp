...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.accounts.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
	...
	def generate_preview(self):
		...
		"hmmerp/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		if len(self.vouchers) > 5:
			...
			frappe.enqueue(
				method="hmmerp.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
