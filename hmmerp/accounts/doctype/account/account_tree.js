...
frappe.treeview_settings["Account"] = {
	...
	filters: [
		{
			...
			on_change: function () {
				...
				frappe.call({
					method: "hmmerp.accounts.doctype.account.account.get_root_company",
					args: {
						company: company,
					},
					callback: function (r) {
	...
	root_label: "Accounts",
	get_tree_nodes: "hmmerp.accounts.utils.get_children",
		...
		frappe.db.get_single_value("Accounts Settings", "show_balance_in_coa").then((value) => {
			if (value) {
				const get_balances = frappe.call({
					method: "hmmerp.accounts.utils.get_account_balances",
					args: {
						accounts: accounts,
	...
	add_tree_node: "hmmerp.accounts.utils.add_ac",
	menu_items: [
		{
		...
		},
		{
			...
			click: function (node, btn) {
				frappe.route_options = {
					from_date: hmmerp.utils.get_fiscal_year(frappe.datetime.get_today(), true)[1],
					to_date: hmmerp.utils.get_fiscal_year(frappe.datetime.get_today(), true)[2],
					company:
