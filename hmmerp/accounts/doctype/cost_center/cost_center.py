...
from hmmerp.accounts.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from hmmerp.accounts.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		from hmmerp.setup.doctype.company.company import get_name_with_abbr
