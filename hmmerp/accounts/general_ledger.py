...
from hmmerp.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from hmmerp.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from hmmerp.accounts.doctype.budget.budget import validate_expense_against_budget
from hmmerp.accounts.utils import create_payment_ledger_entry
from hmmerp.controllers.budget_controller import BudgetValidation
from hmmerp.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else hmmerp.get_default_company()
