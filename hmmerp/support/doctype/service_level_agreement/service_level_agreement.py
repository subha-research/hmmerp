...
from hmmerp.support.doctype.issue.issue import get_holidays
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from hmmerp.support.doctype.service_day.service_day import ServiceDay
		from hmmerp.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from hmmerp.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
