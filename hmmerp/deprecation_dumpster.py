...
### Party starts here
@deprecated(
	"hmmerp.controllers.taxes_and_totals.get_itemised_taxable_amount",
	"2024-11-07",
	"v17",
...
@deprecated(
	"hmmerp.stock.get_pos_profile_item_details",
	"2024-11-19",
	"v16",
	"Use hmmerp.stock.get_pos_profile_item_details_ with a flipped signature",
)
def get_pos_profile_item_details(company, ctx, pos_profile=None, update_data=False):
	from hmmerp.stock.get_item_details import get_pos_profile_item_details_

	return get_pos_profile_item_details_(ctx, company, pos_profile=pos_profile, update_data=update_data)


@deprecated(
	"hmmerp.stock.get_item_warehouse",
	"2024-11-19",
	"v16",
	"Use hmmerp.stock.get_item_warehouse_ with a flipped signature",
)
def get_item_warehouse(item, ctx, overwrite_warehouse, defaults=None):
	from hmmerp.stock.get_item_details import get_item_warehouse_
