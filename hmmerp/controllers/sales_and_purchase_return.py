...
import hmmerp
from hmmerp.stock.serial_batch_bundle import get_batches_from_bundle
from hmmerp.stock.serial_batch_bundle import get_serial_nos as get_serial_nos_from_bundle
...
def validate_quantity(doc, key, args, ref, valid_items, already_returned_items):
	...
	company_currency = hmmerp.get_company_currency(doc.company)
