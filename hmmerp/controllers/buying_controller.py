...
from hmmerp.accounts.doctype.budget.budget import validate_expense_against_budget
from hmmerp.accounts.party import get_party_details
from hmmerp.buying.utils import update_last_purchase_rate, validate_for_items
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if frappe.get_single_value("Accounts Settings", "use_new_budget_controller"):
			from hmmerp.controllers.budget_controller import BudgetValidation
