...
from hmmerp.buying.doctype.purchase_order.test_purchase_order import prepare_data_for_internal_transfer
...
class TestAccountsController(IntegrationTestCase):
	...
	def test_party_billing_and_shipping_address(self):
		from hmmerp.crm.doctype.prospect.test_prospect import make_address
