...
from hmmerp.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
from hmmerp.controllers.accounts_controller import AccountsController
from hmmerp.controllers.sales_and_purchase_return import (
...
from hmmerp.stock.doctype.inventory_dimension.inventory_dimension import (
	get_evaluated_inventory_dimension,
)
from hmmerp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
	get_type_of_transaction,
)
from hmmerp.stock.stock_ledger import get_items_to_be_repost
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False, via_landed_cost_voucher=False):
		...
		if (
			cint(hmmerp.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from hmmerp.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def get_sl_entries(self, d, args):
		...
		if self.docstatus == 2:
			from hmmerp.deprecation_dumpster import deprecation_warning
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from hmmerp.stock.serial_batch_bundle import update_batch_qty
		from hmmerp.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from hmmerp.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from hmmerp.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
...
def get_accounting_ledger_preview(doc, filters):
	from hmmerp.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def get_stock_ledger_preview(doc, filters):
	from hmmerp.stock.report.stock_ledger.stock_ledger import get_columns as get_sl_columns
...
def future_sle_exists(args, sl_entries=None):
	from hmmerp.stock.utils import get_combine_datetime
