...
from hmmerp.accounts.party import render_address
from hmmerp.controllers.accounts_controller import get_taxes_and_charges
from hmmerp.controllers.sales_and_purchase_return import get_rate_for_return
from hmmerp.controllers.stock_controller import StockController
from hmmerp.stock.doctype.item.item import set_item_default
from hmmerp.stock.get_item_details import get_bin_details, get_conversion_factor
from hmmerp.stock.utils import get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from hmmerp.accounts.party import _get_party_details
			...
			from hmmerp.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from hmmerp.controllers.buying_controller import validate_item_type
