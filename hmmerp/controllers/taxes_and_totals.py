...
import hmmerp
from hmmerp.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from hmmerp.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
...
from hmmerp.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template, get_item_tax_map
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = hmmerp.get_company_currency(self.doc.company)
...
from hmmerp.deprecation_dumpster import (
