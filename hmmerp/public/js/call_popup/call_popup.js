			...
			fields: [
				...
				},
				{
					...
					click: () => {
						...
						frappe
							.xcall(
								"hmmerp.telephony.doctype.call_log.call_log.add_call_summary_and_call_type",
								{
