frappe.provide("hmmerp.accounts.bank_reconciliation");

hmmerp.accounts.bank_reconciliation.DialogManager = class DialogManager {
	constructor(
		company,
		bank_account,
	...
	get_linked_vouchers(document_types) {
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.get_linked_payments",
			args: {
	...
	make_dialog() {
		...
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_transaction.bank_transaction.get_doctypes_for_bank_reconciliation",
			callback: (r) => {
	...
	match() {
		...
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.reconcile_vouchers",
			args: {
	...
	add_payment_entry(values) {
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.create_payment_entry_bts",
			args: {
				bank_transaction_name: this.bank_transaction.name,
	...
	add_journal_entry(values) {
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.create_journal_entry_bts",
			args: {
				bank_transaction_name: this.bank_transaction.name,
				reference_number: values.reference_number,
				reference_date: values.reference_date,
	...
	update_transaction(values) {
		frappe.call({
			method: "hmmerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.update_bank_transaction",
			args: {
				bank_transaction_name: this.bank_transaction.name,
				reference_number: values.reference_number,
				party_type: values.party_type,
