frappe.provide("hmmerp.timesheet");

hmmerp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	hmmerp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

hmmerp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
