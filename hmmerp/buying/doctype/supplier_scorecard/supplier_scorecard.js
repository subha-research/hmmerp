...
frappe.ui.form.on("Supplier Scorecard", {
	...
	load_criteria: function (frm) {
		frappe.call({
			method: "hmmerp.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria.get_criteria_list",
			callback: function (r) {
...
frappe.ui.form.on("Supplier Scorecard Scoring Standing", {
	standing_name: function (frm, cdt, cdn) {
		...
		if (d.standing_name) {
			return frm.call({
				method: "hmmerp.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
var loadAllStandings = function (frm) {
	frappe.call({
		method: "hmmerp.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_standings_list",
		callback: function (r) {
