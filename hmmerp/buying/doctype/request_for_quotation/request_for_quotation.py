...
from hmmerp.accounts.party import get_party_account_currency, get_party_details
from hmmerp.buying.utils import validate_for_items
from hmmerp.controllers.buying_controller import BuyingController
from hmmerp.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from hmmerp.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
