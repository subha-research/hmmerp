...
import hmmerp.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable as variable_functions
from hmmerp.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria import (
	get_variables,
)
...
class SupplierScorecardPeriod(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.buying.doctype.supplier_scorecard_scoring_criteria.supplier_scorecard_scoring_criteria import (
			SupplierScorecardScoringCriteria,
		)
		from hmmerp.buying.doctype.supplier_scorecard_scoring_variable.supplier_scorecard_scoring_variable import (
