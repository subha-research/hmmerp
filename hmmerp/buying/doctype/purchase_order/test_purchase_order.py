...
from hmmerp.accounts.party import get_due_date_from_template
...
class TestPurchaseOrder(IntegrationTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from hmmerp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from hmmerp.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from hmmerp.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_update_items_for_subcontracting_purchase_order(self):
		from hmmerp.controllers.tests.test_subcontracting_controller import (
	...
	def test_new_sc_flow(self):
		from hmmerp.buying.doctype.purchase_order.purchase_order import make_subcontracting_order
