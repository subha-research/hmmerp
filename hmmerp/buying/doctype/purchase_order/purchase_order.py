...
from hmmerp.accounts.party import get_party_account, get_party_account_currency
from hmmerp.buying.utils import check_on_hold_or_closed_status, validate_for_items
...
from hmmerp.stock.doctype.item.item import get_item_defaults, get_last_purchase_details
from hmmerp.stock.stock_balance import get_ordered_qty, update_bin_qty
from hmmerp.stock.utils import get_bin
from hmmerp.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (
...
class PurchaseOrder(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.buying.doctype.purchase_order_item.purchase_order_item import PurchaseOrderItem
		from hmmerp.buying.doctype.purchase_order_item_supplied.purchase_order_item_supplied import (
