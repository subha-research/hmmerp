...
class Supplier(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.buying.doctype.customer_number_at_supplier.customer_number_at_supplier import (
	...
	def create_primary_contact(self):
		from hmmerp.selling.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from hmmerp.selling.doctype.customer.customer import make_address
