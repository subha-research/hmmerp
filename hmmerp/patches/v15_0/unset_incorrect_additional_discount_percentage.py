...
from .accounts.report.calculated_discount_mismatch.calculated_discount_mismatch import (
	AFFECTED_DOCTYPES,
...
def execute():
	# run this patch only if  version before update is v15.64.0 or higher
