...
from .accounts.utils import sync_auto_reconcile_config
...
def execute():
	...
	if frappe.reload_doc("core", "doctype", "scheduler_event"):
		method = ".accounts.doctype.process_payment_reconciliation.process_payment_reconciliation.trigger_reconciliation_for_queued_docs"
