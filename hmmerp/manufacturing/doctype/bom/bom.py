...
from hmmerp.stock.doctype.item.item import get_item_details
from hmmerp.stock.get_item_details import ItemDetailsCtx, get_conversion_factor, get_price_list_rate
...
class BOM(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.manufacturing.doctype.bom_explosion_item.bom_explosion_item import BOMExplosionItem
		from hmmerp.manufacturing.doctype.bom_item.bom_item import BOMItem
		from hmmerp.manufacturing.doctype.bom_operation.bom_operation import BOMOperation
		from hmmerp.manufacturing.doctype.bom_scrap_item.bom_scrap_item import BOMScrapItem
	...
	def company_currency(self):
		return hmmerp.get_company_currency(self.company)
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None):
	from hmmerp.stock.doctype.stock_entry.stock_entry import get_operating_cost_per_unit
...
def make_variant_bom(source_name, bom_no, item, variant_items, target_doc=None):
	from hmmerp.manufacturing.doctype.work_order.work_order import add_variant_item
