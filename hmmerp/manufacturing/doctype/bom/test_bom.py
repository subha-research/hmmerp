...
from hmmerp.manufacturing.doctype.bom.bom import BOMRecursionError, item_query, make_variant_bom
from hmmerp.manufacturing.doctype.bom_update_log.test_bom_update_log import (
...
class TestBOM(IntegrationTestCase):
	...
	def test_get_items_list(self):
		from hmmerp.manufacturing.doctype.bom.bom import get_bom_items
	...
	def test_do_not_include_manufacturing_and_fixed_items(self):
		from hmmerp.manufacturing.doctype.bom.bom import item_query
