...
from hmmerp.manufacturing.doctype.bom.bom import get_children as get_bom_children
from hmmerp.manufacturing.doctype.bom.bom import validate_bom_no
from hmmerp.manufacturing.doctype.work_order.work_order import get_item_details
...
from hmmerp.stock.get_item_details import get_conversion_factor
from hmmerp.stock.utils import get_or_make_bin
from hmmerp.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from hmmerp.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from hmmerp.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from hmmerp.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from hmmerp.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from hmmerp.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from hmmerp.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def make_work_order(self):
		from hmmerp.manufacturing.doctype.work_order.work_order import get_default_warehouse
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from hmmerp.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from hmmerp.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
