...
from hmmerp.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from hmmerp.stock.doctype.batch.batch import make_batch
from hmmerp.stock.doctype.item.item import get_item_defaults, validate_end_of_life
from hmmerp.stock.doctype.serial_no.serial_no import get_available_serial_nos, get_serial_nos
from hmmerp.stock.doctype.stock_reservation_entry.stock_reservation_entry import StockReservation
from hmmerp.stock.stock_balance import get_planned_qty, update_bin_qty
from hmmerp.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.manufacturing.doctype.work_order_item.work_order_item import WorkOrderItem
		from hmmerp.manufacturing.doctype.work_order_operation.work_order_operation import WorkOrderOperation
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from hmmerp.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_stock_return_entry(work_order):
	from hmmerp.stock.doctype.stock_entry.stock_entry import get_available_materials
