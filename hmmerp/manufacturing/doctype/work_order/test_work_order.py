...
from hmmerp.manufacturing.doctype.job_card.job_card import JobCardCancelError
from hmmerp.manufacturing.doctype.job_card.job_card import make_stock_entry as make_stock_entry_from_jc
...
from hmmerp.stock.doctype.stock_entry import test_stock_entry
...
class TestWorkOrder(IntegrationTestCase):
	...
	def test_wo_completion_with_pl_bom(self):
		from hmmerp.manufacturing.doctype.bom.test_bom import (
	...
	def test_stock_reservation_for_serialized_raw_material(self):
		from hmmerp.stock.doctype.stock_entry.stock_entry_utils import (
			make_stock_entry as make_stock_entry_test_record,
		)
	...
	def test_operations_time_planning_calculation(self):
		from hmmerp.manufacturing.doctype.routing.test_routing import create_routing, setup_operations
...
def prepare_data_for_workstation_type_check():
	from hmmerp.manufacturing.doctype.operation.test_operation import make_operation
	from hmmerp.manufacturing.doctype.workstation.test_workstation import make_workstation
	from hmmerp.manufacturing.doctype.workstation_type.test_workstation_type import (
