...
from hmmerp.manufacturing.doctype.job_card.job_card import (
...
from hmmerp.manufacturing.doctype.work_order.work_order import WorkOrder
...
class TestJobCard(ERPNextTestSuite):
	...
	def test_if_corrective_jc_ops_cost_is_added_to_manufacture_stock_entry(self):
		...
		from hmmerp.manufacturing.doctype.work_order.work_order import make_job_card
	...
	def test_job_card_material_request_and_bom_details(self):
		from hmmerp.stock.doctype.material_request.material_request import make_stock_entry
	...
	def test_job_card_proccess_qty_and_completed_qty(self):
		from hmmerp.manufacturing.doctype.routing.test_routing import (
			create_routing,
			setup_bom,
			setup_operations,
		)
