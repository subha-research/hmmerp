...
from hmmerp.manufacturing.doctype.bom.bom import get_bom_item_rate
...
class BOMCreator(Document):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.manufacturing.doctype.bom_creator_item.bom_creator_item import BOMCreatorItem
