...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "hmmerp.controllers.queries.item_query";
		dialog.show();
	},
...
hmmerp.bom.BomConfigurator = class BomConfigurator extends hmmerp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new hmmerp.bom.BomConfigurator({ frm: cur_frm }));
