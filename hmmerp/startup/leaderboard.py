...
def get_leaderboards():
	leaderboards = {
		"Customer": {
			...
			"method": "hmmerp.startup.leaderboard.get_all_customers",
			"icon": "customer",
		},
		"Item": {
			"fields": [
			...
			"method": "hmmerp.startup.leaderboard.get_all_items",
			"icon": "stock",
		},
		"Supplier": {
			"fields": [
			...
			"method": "hmmerp.startup.leaderboard.get_all_suppliers",
			"icon": "buying",
		},
		"Sales Partner": {
			"fields": [
			...
			"method": "hmmerp.startup.leaderboard.get_all_sales_partner",
			"icon": "hr",
		},
		"Sales Person": {
			"fields": [{"fieldname": "total_sales_amount", "fieldtype": "Currency"}],
			"method": "hmmerp.startup.leaderboard.get_all_sales_person",
			"icon": "customer",
		},
	}
