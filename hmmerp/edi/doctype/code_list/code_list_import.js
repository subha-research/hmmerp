frappe.provide("hmmerp.edi");

hmmerp.edi.import_genericode = function (listview_or_form) {
	...
	new frappe.ui.FileUploader({
		method: "hmmerp.edi.doctype.code_list.code_list_import.import_genericode",
		doctype: doctype,
		docname: docname,
...
function show_column_selection_dialog(context) {
	...
	let d = new frappe.ui.Dialog({
		...
		primary_action(values) {
			...
			frappe
				.xcall("hmmerp.edi.doctype.code_list.code_list_import.process_genericode_import", {
