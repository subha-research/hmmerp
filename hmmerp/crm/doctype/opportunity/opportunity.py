...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.crm.doctype.crm_note.crm_note import CRMNote
		from hmmerp.crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from hmmerp.crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
...
def make_quotation(source_name, target_doc=None):
	def set_missing_values(source, target):
		from hmmerp.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(communication, company, ignore_communication_links=False):
	from hmmerp.crm.doctype.lead.lead import make_lead_from_communication
