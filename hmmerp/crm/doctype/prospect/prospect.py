...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from hmmerp.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from hmmerp.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
