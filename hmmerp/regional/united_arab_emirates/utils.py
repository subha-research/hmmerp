...
import hmmerp
from hmmerp.controllers.taxes_and_totals import get_itemised_tax
...
def update_totals(vat_tax, base_vat_tax, doc):
	...
	doc.base_in_words = money_in_words(doc.base_grand_total, hmmerp.get_company_currency(doc.company))
