...
from hmmerp.controllers.taxes_and_totals import ItemWiseTaxDetail, get_itemised_tax
from hmmerp.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"hmmerp/regional/italy/e-invoice.xml",
